...
{% endhighlight %}
<figure>
<figcaption class="caption">[Shell 1] Host Network Interface Packet</figcaption>
</figure>
...
{% endhighlight %}
<figure>
<figcaption class="caption">[Shell 2] Container Network Interface Packet</figcaption>
</figure>
