...
![[그림 1] Linux의 Process Tree]({{site.baseurl}}/images/onebyone_container/PID_Namespace/Linux_Process_Tree.PNG){: width="500px"}
...
![[그림 2] Linux의 고아 Process 처리]({{site.baseurl}}/images/onebyone_container/PID_Namespace/Orphan_Process.PNG){: width="500px"}
...
![[그림 3] Linux의 Zombie Process 처리]({{site.baseurl}}/images/onebyone_container/PID_Namespace/Orphan_Process.PNG){: width="500px"}
...
![[그림 5] Nested Container PID Namespace]({{site.baseurl}}/images/onebyone_container/PID_Namespace/Container_PID_Namespace.PNG)
