...
![[그림 2] Orphan, Zombie Process with PID Namespace]({{site.baseurl}}/images/onebyone_container/PID_Namespace/Orphan_Zombie_Process_with_PID_Namespace.PNG){: width="600px"}
