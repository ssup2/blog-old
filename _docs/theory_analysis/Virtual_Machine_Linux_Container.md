...
![[그림 1] Virtual Machine]({{site.baseurl}}/images/theory_analysis/Virtual_Machine_Linux_Container/Virtual_Machine.PNG){: width="500px"}
...
![[그림 2] Linux Container]({{site.baseurl}}/images/theory_analysis/Virtual_Machine_Linux_Container/Linux_Container.PNG){: width="500px"}
