...
![[그림 1] iptables Mode에서 Service Packet의 NAT Table 경로]({{site.baseurl}}/images/theory_analysis/Kubernetes_Service_Proxy/Kubernetes_iptables_Service_NAT_Table.PNG)
...
![[그림 2] iptables Masquerade]({{site.baseurl}}/images/theory_analysis/Kubernetes_Service_Proxy/Kubernetes_iptables_Masquerade.PNG){: width="650px"}
