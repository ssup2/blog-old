...
eos
        ...
        def add_code_tag(code)
          ...
          res += "<figcaption class=\"caption\">#{@highlight_options[:caption]}</figcaption>" if @highlight_options[:caption]
          res += "</figure>"
          res
        end
      end
  ...
  Liquid::Template.register_tag("highlight_cap", Czak::Tags::HighlightCaptionBlock)